...
events.on("push", (brigadeEvent, project) => {
    ...
    brigConfig.set("apiImage", "torosent/smackapi")
...
events.on("pull_request", (brigadeEvent, project) => {
    ...
    console.log(`PR ==> gitHub webook (${brigConfig.get("branch")}) with commit ID ${brigConfig.get("gitSHA")}`)
    ...
    goJobRunner(golang)
    dockerJobRunner(brigConfig, docker)
    helmJobRunner(brigConfig, helm, 50, 50, "new")
