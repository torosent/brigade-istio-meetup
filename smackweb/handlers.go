...
func homeHandler(w http.ResponseWriter, r *http.Request) {
	...
	var htmlHeader = "<!DOCTYPE html><html><head><style>table, th, td {border: 1px solid black;font-family: 'Courier New';font-size: 28px;color: white}th, td {padding: 20px;}</style></head><font color=black><h1>Microsmack Homepage - Meetup 2018 </h1><body style=background-color:white>"
